...
public final class CustomSerdes {
    ...
    public static Serde<EventAggregate> EventAggregate() {
        JsonSerializer<EventAggregate> serializer = new JsonSerializer<>();
        JsonDeserializer<EventAggregate> deserializer = new JsonDeserializer<>(EventAggregate.class);
        return Serdes.serdeFrom(serializer, deserializer);
    }
